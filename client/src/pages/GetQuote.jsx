...
export default function GetQuote() {
  ...
  return (
    <div className="min-h-screen bg-bgPrimary pt-20 pb-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16 flex flex-col lg:flex-row gap-16">
        ...
        <div className="w-full lg:w-[45%] flex flex-col">
          <h1 className="text-4xl md:text-5xl font-hero font-medium uppercase mb-4">Start Your Project</h1>
          ...
          <div className="mt-auto glass p-6 rounded-2xl border-neonPrimary/20">
            ...
            <div className="flex gap-4">
              <a href="mailto:hello@skyzenitservices.com" className="hover:text-neonPrimary transition-colors flex items-center gap-2">
                <Mail className="w-4 h-4" /> Email Us
              </a>
              <span className="text-surfaceElevated">|</span>
              <a href="https://wa.me/919389491488" target="_blank" rel="noreferrer" className="hover:text-neonPrimary transition-colors flex items-center gap-2 text-green-400">
        ...
        <div className="w-full lg:w-[55%]">
          {status === 'success' ? (
            <div className="glass p-12 rounded-3xl text-center flex flex-col items-center">
              ...
              <h3 className="text-3xl font-hero font-medium mb-4">Request Sent!</h3>
            ...
            <form action="https://formsubmit.co/skyzenitservices@gmail.com" method="POST" onSubmit={handleSubmit} className="form-container glass p-8 md:p-12 rounded-3xl shadow-2xl relative">
