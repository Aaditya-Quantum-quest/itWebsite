...
export default function About() {
  ...
  return (
    <div className="flex flex-col pt-24 bg-bgPrimary">
      {/* Hero */}
      <section className="py-20 text-center container mx-auto px-4 reveal-heading">
        <h1 className="text-4xl md:text-6xl font-hero font-bold mb-6">Built by Builders.<br/>Driven by <span className="text-transparent bg-clip-text bg-gradient-cyan-purple">Impact.</span></h1>
        <p className="text-textSecondary text-lg max-w-3xl mx-auto leading-relaxed">
          NexaForge is a collective of engineers, designers, and strategists. We believe in writing clean code, designing intuitive interfaces, and solving the hard problems that hold innovation back.
        </p>
      </section>
            ...
            return (
              <div key={i} className={`relative flex flex-col md:flex-row justify-between items-start md:items-center w-full mb-16 reveal-card ${isEven ? 'md:flex-row-reverse' : ''}`}>
                ...
                <div className={`w-full md:w-5/12 pl-12 md:pl-0 ${isEven ? 'md:text-left md:pr-12' : 'md:text-right md:pl-12'}`}>
                  <span className="text-neonPrimary font-mono font-bold text-xl mb-2 block">{item.year}</span>
