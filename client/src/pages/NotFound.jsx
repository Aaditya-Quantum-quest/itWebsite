  ...
  return (
    <section className="relative min-h-[calc(100vh-72px)] flex items-center justify-center pt-10 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center not-found-content">
        <h1 className="text-8xl md:text-[12rem] font-hero font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-textPrimary to-bgPrimary/50 leading-none mb-4">
          404
        </h1>
        <h2 className="text-3xl md:text-5xl font-heading font-bold mb-6">Page Not Found</h2>
        ...
        <Link to="/">
          <button className="px-8 py-4 glass rounded-full font-heading font-bold text-textPrimary hover:border-neonPrimary hover:shadow-glow-primary transition-all relative overflow-hidden group">
