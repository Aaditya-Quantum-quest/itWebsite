...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 bg-bgPrimary flex flex-col relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 gap-6 mt-8">
            <div className="glass p-6 rounded-2xl flex items-start gap-4 hover:border-neonPrimary/30 transition-colors">
              ...
              <div>
                ...
                <a href="mailto:hello@nexaforge.com" className="text-neonPrimary text-sm font-medium hover:underline">hello@nexaforge.com</a>
              </div>
            </div>
            ...
            <div className="glass p-6 rounded-2xl flex items-start gap-4 hover:border-neonPrimary/30 transition-colors">
              ...
              <div>
                ...
                <a href="tel:+1234567890" className="text-[#25D366] text-sm font-medium hover:underline">+1 (234) 567-890</a>
              </div>
            </div>
        ...
        <div className="w-full lg:w-7/12">
          {status === 'success' ? (
             <div className="glass h-full min-h-[500px] rounded-3xl flex flex-col items-center justify-center p-12 text-center border-success/30 shadow-[0_0_50px_rgba(0,255,136,0.1)]">
               ...
               <h3 className="text-3xl font-hero font-bold mb-4">Message Received!</h3>
               <p className="text-textSecondary">Thanks for reaching out. A team member will reply shortly.</p>
             </div>
          ) : (
            <form onSubmit={handleSubmit} className="contact-form glass p-8 md:p-12 rounded-3xl shadow-2xl relative border-neonPrimary/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-2">
                  ...
                  <input type="text" required className="w-full px-4 py-3 bg-surfaceElevated border border-white/5 focus:border-neonPrimary rounded-xl outline-none transition-colors" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-textSecondary px-1">Email</label>
                  <input type="email" required className="w-full px-4 py-3 bg-surfaceElevated border border-white/5 focus:border-neonPrimary rounded-xl outline-none transition-colors" />
                </div>
              </div>

              <div className="space-y-2 mb-6">
                <label className="text-sm font-medium text-textSecondary px-1">Subject</label>
                <select className="w-full px-4 py-3 bg-surfaceElevated border border-white/5 focus:border-neonPrimary rounded-xl outline-none appearance-none transition-colors text-textPrimary">
              ...
              <div className="space-y-2 mb-8">
                ...
                <textarea required className="w-full h-40 px-4 py-3 bg-surfaceElevated border border-white/5 focus:border-neonPrimary rounded-xl outline-none resize-none transition-colors" />
              </div>
