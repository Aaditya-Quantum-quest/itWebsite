    ...
    <section className="py-16 sm:py-24 lg:py-32 bg-bgPrimary">
      <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-16">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-[40px] left-[5%] sm:left-[10%] right-[5%] sm:right-[10%] h-[2px] bg-surfaceElevated overflow-hidden">
            ...
            {steps.map((step, i) => (
              <div key={i} className="flex flex-col items-center text-center group w-full lg:w-[200px] reveal-card">
                <div className="relative mb-4 sm:mb-6">
                  ...
                  {i !== steps.length - 1 && (
                    <div className="lg:hidden absolute top-[60px] sm:top-[80px] left-1/2 w-[2px] h-[calc(100%+24px)] border-l-2 border-dashed border-neonPrimary/30 transform -translate-x-1/2 -z-10" />
                  )}
                ...
                <h4 className="text-lg sm:text-xl font-heading font-semibold text-textPrimary mb-2 sm:mb-3">{step.title}</h4>
                <p className="text-sm text-textSecondary font-body leading-relaxed max-w-[200px] sm:max-w-[240px] mx-auto lg:max-w-none">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
