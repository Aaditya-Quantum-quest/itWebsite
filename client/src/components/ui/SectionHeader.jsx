  ...
  return (
    <div className={`flex flex-col items-center text-center max-w-3xl mx-auto mb-16 ${className} reveal-heading`}>
      <div className="flex items-center gap-4 mb-4">
        ...
        <span className="text-neonPrimary font-mono text-sm uppercase tracking-[0.15em] font-semibold">
          {label}
        </span>
        <div className="w-10 h-[1px] bg-neonPrimary/40" />
      </div>
      <h2 className="text-3xl md:text-5xl uppercase font-hero font-medium mb-6 !leading-tight text-textPrimary">
        {title} 
      </h2>
      {subtitle && (
